(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[32413],{
27888:(e,
t,
i)=>{
"use strict";
...
`)>=0&&((p=r.match(/(Version)\/([\d.]+)/))||(p=[0,1,
"13_0_0"]),
f=!1),
c&&"Win32"!==s&&(l.os="android",
l.android=!0),(p||h||u)&&(l.os="ios",
l.ios=!0),
l
}
(e)),
...
let[e,
s]=t.split("Version/")[1].split(" ")[0].split(".").map(e=>Number(e));
i=e<16||16===e&&s<2
}
...
let i=t.closest(e.isElement?"swiper-slide":`.${
e.params.slideClass
}
`);
if(i){
...
`);
!t&&e.isElement&&(i.shadowRoot?t=i.shadowRoot.querySelector(`.${
e.params.lazyPreloaderClass
}
`):requestAnimationFrame(()=>{
i.shadowRoot&&(t=i.shadowRoot.querySelector(`.${
e.params.lazyPreloaderClass
}
`))&&!t.lazyPreloaderManaged&&t.remove()
}
)),
...
let l=r+s-1;
if(e.params.rewind||e.params.loop)for(let s=r-t;
s<=l+t;
s+=1){
let t=(s%i+i)%i;
(t<r||t>l)&&m(e,
...
=e,
a=i;
a||(a=r>l?"next":r<l?"prev":"reset"),
e.emit(`transition${
s
}
`),
t&&"reset"===a?e.emit(`slideResetTransition${
s
}
`):t&&r!==l&&(e.emit(`slideChangeTransition${
s
}
`),
"next"===a?e.emit(`slideNextTransition${
s
}
`):e.emit(`slidePrevTransition${
s
}
`))
}
...
if("touchstart"===i.type)return void w(this,
i,
i.targetTouches[0].pageX);
let{
params:r,
touches:l,
enabled:a
...
let u=r.noSwipingSelector?r.noSwipingSelector:`.${
r.noSwipingClass
}
`,
h=!!(i.target&&i.target.shadowRoot);
if(r.noSwiping&&(h?function(e,
t=this){
return function t(i){
if(!i||i===(0,
n.g)()||i===(0,
...
(r.touchStartForcePreventDefault||v)&&!d.isContentEditable&&i.preventDefault(),
...
"pointermove"===p.type&&(null!==r.touchId||p.pointerId!==r.pointerId))return;
if("touchmove"===p.type){
if(!(t=[...p.changedTouches].find(e=>e.identifier===r.touchId))||t.identifier!==r.touchId)return
}
else t=p;
if(!r.isTouched){
r.startMoving&&r.isScrolling&&this.emit("touchMoveOpposite",
p);
return
}
let u=t.pageX,
...
else if(d&&(u>a.startX&&-this.translate<=this.maxTranslate()||u<a.startX&&-this.translate>=this.minTranslate()))return;
else if(!d&&(u<a.startX&&this.translate<=this.maxTranslate()||u>a.startX&&this.translate>=this.minTranslate()))return
}
...
r.allowTouchCallbacks&&this.emit("touchMove",
p),
...
let e;
this.isHorizontal()&&a.currentY===a.startY||this.isVertical()&&a.currentX===a.startX?r.isScrolling=!1:f*f+m*m>=25&&(e=180*Math.atan2(Math.abs(m),
Math.abs(f))/Math.PI,
r.isScrolling=this.isHorizontal()?e>l.touchAngle:90-e>l.touchAngle)
}
if(r.isScrolling&&this.emit("touchMoveOpposite",
p),
...
this.allowClick=!1,!l.cssMode&&p.cancelable&&p.preventDefault(),
l.touchMoveStopPropagation&&!l.nested&&p.stopPropagation();
let g=this.isHorizontal()?f:m,
v=this.isHorizontal()?a.currentX-a.previousX:a.currentY-a.previousY;
l.oneWayMovement&&(g=Math.abs(g)*(d?1:-1),
v=Math.abs(v)*(d?1:-1)),
a.diff=g,
g*=l.touchRatio,
d&&(g=-g,
...
this.emit("sliderFirstMove",
p)
}
if(new Date().getTime(),!1!==l._loopSwapReset&&r.isMoved&&r.allowThresholdMove&&w!==this.touchesDirection&&S&&b&&Math.abs(g)>=1){
Object.assign(a,{
startX:u,
startY:h,
currentX:u,
...
g>0?(S&&b&&!i&&r.allowThresholdMove&&r.currentTranslate>(l.centeredSlides?this.minTranslate()-this.slidesSizesGrid[this.activeIndex+1]-("auto"!==l.slidesPerView&&this.slides.length-l.slidesPerView>=2?this.slidesSizesGrid[this.activeIndex+1]+this.params.spaceBetween:0)-this.params.spaceBetween:this.minTranslate())&&this.loopFix({
direction:"prev",
setTranslate:!0,
activeSlideIndex:0
}
...
l.resistance&&(r.currentTranslate=this.minTranslate()-1+(-this.minTranslate()+r.startTranslate+g)**y))):g<0&&(S&&b&&!i&&r.allowThresholdMove&&r.currentTranslate<(l.centeredSlides?this.maxTranslate()+this.slidesSizesGrid[this.slidesSizesGrid.length-1]+this.params.spaceBetween+("auto"!==l.slidesPerView&&this.slides.length-l.slidesPerView>=2?this.slidesSizesGrid[this.slidesSizesGrid.length-1]+this.params.spaceBetween:0):this.maxTranslate())&&this.loopFix({
direction:"next",
setTranslate:!0,
...
l.resistance&&(r.currentTranslate=this.maxTranslate()+1-(this.maxTranslate()-r.startTranslate-g)**y))),
T&&(p.preventedByNestedSwiper=!0),!this.allowSlideNext&&"next"===this.swipeDirection&&r.currentTranslate<r.startTranslate&&(r.currentTranslate=r.startTranslate),!this.allowSlidePrev&&"prev"===this.swipeDirection&&r.currentTranslate>r.startTranslate&&(r.currentTranslate=r.startTranslate),
this.allowSlidePrev||this.allowSlideNext||(r.currentTranslate=r.startTranslate),
l.threshold>0)if(Math.abs(g)>l.threshold||r.allowThresholdMove){
...
if(!(t=[...l.changedTouches].find(e=>e.identifier===r.touchId))||t.identifier!==r.touchId)return
}
else{
...
"pointerout",
"pointerleave",
"contextmenu"].includes(l.type)&&!(["pointercancel",
"contextmenu"].includes(l.type)&&(s.browser.isSafari||s.browser.isWebView)))return;
r.pointerId=null,
r.touchId=null;
let{
params:a,
...
=s;
if(!p||!a.simulateTouch&&"mouse"===l.pointerType)return;
if(r.allowTouchCallbacks&&s.emit("touchEnd",
l),
r.allowTouchCallbacks=!1,!r.isTouched){
...
s.updateClickedSlide(e&&e[0]||l.target,
e),
s.emit("tap click",
l),
h<300&&u-r.lastClickTime<300&&s.emit("doubleTap doubleClick",
l)
}
...
a.cssMode)return;
if(a.freeMode&&a.freeMode.enabled)return void s.freeMode.onTouchEnd({
currentPos:i
}
);
...
g=c[e+t]-c[e]):(f||i>=c[e])&&(m=e,
g=c[c.length-1]-c[c.length-2])
}
let v=null,
w=null;
a.rewind&&(s.isBeginning?w=a.virtual&&a.virtual.enabled&&s.virtual?s.virtual.slides.length-1:s.slides.length-1:s.isEnd&&(v=0));
let S=(i-c[m])/g,
b=m<a.slidesPerGroupSkip-1?1:a.slidesPerGroup;
if(h>a.longSwipesMs){
if(!a.longSwipes)return void s.slideTo(s.activeIndex);
"next"===s.swipeDirection&&(S>=a.longSwipesRatio?s.slideTo(a.rewind&&s.isEnd?v:m+b):s.slideTo(m)),
...
s.navigation&&(l.target===s.navigation.nextEl||l.target===s.navigation.prevEl)?l.target===s.navigation.nextEl?s.slideTo(m+b):s.slideTo(m):("next"===s.swipeDirection&&s.slideTo(null!==v?v:m+b),
...
this.isHorizontal()?this.translate=-e.scrollLeft:this.translate=-e.scrollTop,0===this.translate&&(this.translate=0),
...
function M(e){
f(this,
e.target),!this.params.cssMode&&("auto"===this.params.slidesPerView||this.params.autoHeight)&&this.update()
}
function P(){
...
r&&"string"!=typeof r&&(i[d]("touchstart",
e.onDocumentTouchStart,{
passive:!1,
capture:o
}
),
...
),(s.preventClicks||s.preventClicksPropagation)&&r[d]("click",
e.onClick,!0),
s.cssMode&&l[d]("scroll",
e.onScroll),
s.updateOnWindowResize?e[t](a.ios||a.android?"resize orientationchange observerUpdate":"resize observerUpdate",
y,!0):e[t]("observerUpdate",
y,!0),
r[d]("load",
e.onLoad,{
capture:!0
...
void 0===t?i.eventsListeners[e]=[]:i.eventsListeners[e]&&i.eventsListeners[e].forEach((s,
r)=>{
...
s,
r=this;
return r.eventsListeners&&!r.destroyed&&r.eventsListeners&&("string"==typeof e[0]||Array.isArray(e[0])?(t=e[0],
i=e.slice(1,
e.length),
s=r):(t=e[0].events,
i=e[0].data,
s=e[0].context||r),
i.unshift(s),(Array.isArray(t)?t:t.split(" ")).forEach(e=>{
...
t=void 0!==this.params.height&&null!==this.params.height?this.params.height:i.clientHeight,0===e&&this.isHorizontal()||0===t&&this.isVertical()||(e=e-parseInt((0,
o.q)(i,
"padding-left")||0,10)-parseInt((0,
o.q)(i,
"padding-right")||0,10),
t=t-parseInt((0,
o.q)(i,
"padding-top")||0,10)-parseInt((0,
o.q)(i,
"padding-bottom")||0,10),
Number.isNaN(e)&&(e=0),
Number.isNaN(t)&&(t=0),
...
""))/100*b:"string"==typeof T&&(T=parseFloat(T)),
t.virtualSize=-T-g-v,
p.forEach(e=>{
...
s.cssMode&&((0,
o.b)(r,
"--swiper-slides-offset-before",`${
g
}
px`),(0,
o.b)(r,
"--swiper-slides-offset-after",`${
v
}
px`));
let M=s.grid&&s.grid.rows>1&&t.grid;
M?t.grid.initSlides(p):t.grid&&t.grid.unsetSlides();
let P="auto"===s.slidesPerView&&s.breakpoints&&Object.keys(s.breakpoints).filter(e=>void 0!==s.breakpoints[e].slidesPerView).length>0;
for(let r=0;
r<u;
r+=1){
e=0;
let l=p[r];
if(!l||(M&&t.grid.updateSlide(r,
l,
p),
"none"!==(0,
o.q)(l,
"display"))){
if(d&&"auto"===s.slidesPerView)s.virtual.slidesPerViewAutoSlideSize&&(e=s.virtual.slidesPerViewAutoSlideSize),
e&&l&&(s.roundLengths&&(e=Math.floor(e)),
l.style[t.getDirectionLabel("width")]=`${
e
}
px`);
else if("auto"===s.slidesPerView){
P&&(l.style[t.getDirectionLabel("width")]="");
let r=getComputedStyle(l),
a=l.style.transform,
n=l.style.webkitTransform;
if(a&&(l.style.transform="none"),
n&&(l.style.webkitTransform="none"),
s.roundLengths)e=t.isHorizontal()?(0,
o.i)(l,
"width",!0):(0,
o.i)(l,
"height",!0);
...
a&&(l.style.transform=a),
n&&(l.style.webkitTransform=n),
s.roundLengths&&(e=Math.floor(e))
}
else e=(b-(s.slidesPerView-1)*T)/s.slidesPerView,
s.roundLengths&&(e=Math.floor(e)),
l&&(l.style[t.getDirectionLabel("width")]=`${
e
}
px`);
l&&(l.swiperSlideSize=e),
m.push(e),
s.centeredSlides?(y=y+e/2+E/2+T,0===E&&0!==r&&(y=y-b/2-T),0===r&&(y=y-b/2-T),.001>Math.abs(y)&&(y=0),
s.roundLengths&&(y=Math.floor(y)),
x%s.slidesPerGroup==0&&h.push(y),
f.push(y)):(s.roundLengths&&(y=Math.floor(y)),(x-Math.min(t.params.slidesPerGroupSkip,
x))%t.params.slidesPerGroup==0&&h.push(y),
f.push(y),
y=y+e+T),
t.virtualSize+=e+T,
E=e,
...
b)+v,
a&&n&&("slide"===s.effect||"coverflow"===s.effect)&&(r.style.width=`${
t.virtualSize+T
}
px`),
s.setWrapperSize&&(r.style[t.getDirectionLabel("width")]=`${
t.virtualSize+T
}
px`),
M&&t.grid.updateWrapperSize(e,
h),!s.centeredSlides){
...
e=1;
let t=0;
for(let i=m.length-1;
i>=0;
i-=1)if((t+=m[i]+(i<m.length-1?T:0))<=b)e=m.length-i;
else break
}
...
i?e<=r&&l.push(a):h[e]<=t.virtualSize-b&&l.push(a)
}
h=l,
Math.floor(t.virtualSize-b)-Math.floor(h[h.length-1])>1&&!i&&h.push(t.virtualSize-b)
}
if(d&&s.loop){
let e=m[0]+T;
...
for(let e=0;
e<i;
e+=1)h.push(h[h.length-1]+r)
}
for(let i=0;
i<t.virtual.slidesBefore+t.virtual.slidesAfter;
i+=1)1===s.slidesPerGroup&&h.push(h[h.length-1]+e),
...
p.filter((e,
t)=>!s.cssMode||!!s.loop||t!==p.length-1).forEach(t=>{
t.style[e]=`${
T
}
px`
...
t.emit("slidesUpdated"),!d&&!s.cssMode&&("slide"===s.effect||"fade"===s.effect)){
let e=`${
...
if("auto"!==i.params.slidesPerView&&i.params.slidesPerView>1)if(i.params.centeredSlides)(i.visibleSlides||[]).forEach(e=>{
s.push(e)
}
);
else for(t=0;
...
(l||0===l)&&(i.wrapperEl.style.height=`${
l
}
px`)
}
...
for(let i=0;
i<e.length;
i+=1)e[i].swiperSlideOffset=(this.isHorizontal()?e[i].offsetLeft:e[i].offsetTop)-t-this.cssOverflowAdjustment()
}
,
...
""))/100*this.size:"string"==typeof a&&(a=parseFloat(a));
for(let e=0;
e<i.length;
e+=1){
let n=i[e],
...
l&&!o&&this.emit("reachEnd toEdge"),(n&&!r||o&&!l)&&this.emit("fromEdge"),
this.emit("progress",
s)
}
,
...
e=c(`[data-swiper-slide-index="${
t
}
"]`)
}
else e=c(`[data-swiper-slide-index="${
a
}
"]`);
else d?(e=s.find(e=>e.column===a),
...
for(let e=0;
e<i.length;
e+=1)void 0!==i[e+1]?r>=i[e]&&r<i[e+1]-(i[e+1]-i[e])/2?t=e:r>=i[e]&&r<i[e+1]&&(t=e+1):r>=i[e]&&(t=e);
return s.normalizeSlideIndex&&(t<0||void 0===t)&&(t=0),
t
}
(s)),
l.indexOf(r)>=0)t=l.indexOf(r);
else{
let e=Math.min(a.slidesPerGroupSkip,
c);
...
let u=s.grid&&a.grid&&a.grid.rows>1;
if(s.virtual&&a.virtual.enabled)i=a.loop?p(c):c;
else if(u){
...
s.emit("snapIndexChange"),(s.initialized||s.params.runCallbacksOnInit)&&(o!==i&&s.emit("realIndexChange"),
s.emit("slideChange"))
}
,
...
,
swiper-slide`);
!r&&this.isElement&&t&&t.length>1&&t.includes(e)&&[...t.slice(t.indexOf(e)+1,
t.length)].forEach(e=>{
!r&&e.matches&&e.matches(`.${
s.slideClass
}
,
swiper-slide`)&&(r=e)
...
a=0,
n=0;
this.isHorizontal()?a=i?-e:e:n=e,
s.roundLengths&&(a=Math.floor(a),
n=Math.floor(n)),
this.previousTranslate=this.translate,
this.translate=this.isHorizontal()?a:n,
s.cssMode?r[this.isHorizontal()?"scrollLeft":"scrollTop"]=this.isHorizontal()?-a:-n:s.virtualTranslate||(this.isHorizontal()?a-=this.cssOverflowAdjustment():n-=this.cssOverflowAdjustment(),
...
(0===o?0:(e-this.minTranslate())/o)!==l&&this.updateProgress(e),
this.emit("setTranslate",
this.translate,
t)
}
...
p=a.maxTranslate();
if(l=s&&e>c?c:s&&e<p?p:e,
a.updateProgress(l),
n.cssMode){
let e=a.isHorizontal();
if(0===t)d[e?"scrollLeft":"scrollTop"]=-l;
else{
if(!a.support.smoothScroll)return(0,
o.u)({
swiper:a,
targetPosition:-l,
side:e?"left":"top"
...
a.setTranslate(l),
i&&(a.emit("beforeTransitionStart",
t,
r),
...
a&&!a.destroyed&&e.target===this&&(a.wrapperEl.removeEventListener("transitionend",
...
a.onTranslateToWrapperTransitionEnd))),!0
}
...
t){
this.params.cssMode||(this.wrapperEl.style.transitionDuration=`${
e
}
ms`,
...
=a;
if(!v&&!s&&!r||a.destroyed||a.animating&&d.preventInteractionOnTransition)return!1;
void 0===t&&(t=a.params.speed);
let w=Math.min(a.params.slidesPerGroupSkip,
n),
S=w+Math.floor((n-w)/a.params.slidesPerGroup);
S>=c.length&&(S=c.length-1);
let b=-c[S];
if(d.normalizeSlideIndex)for(let e=0;
e<u.length;
e+=1){
...
if(a.initialized&&n!==f&&(!a.allowSlideNext&&(m?b>a.translate&&b>a.minTranslate():b<a.translate&&b<a.minTranslate())||!a.allowSlidePrev&&b>a.translate&&b>a.maxTranslate()&&(f||0)!==n))return!1;
n!==(h||0)&&i&&a.emit("beforeSlideChangeStart"),
a.updateProgress(b),
l=n>f?"next":n<f?"prev":"reset";
let T=a.virtual&&a.params.virtual.enabled;
if(!(T&&r)&&(m&&-b===a.translate||!m&&b===a.translate))return a.updateActiveIndex(n),
d.autoHeight&&a.updateAutoHeight(),
a.updateSlidesClasses(),
"slide"!==d.effect&&a.setTranslate(b),
"reset"!==l&&(a.transitionStart(i,
l),
a.transitionEnd(i,
l)),!1;
if(d.cssMode){
let e=a.isHorizontal(),
i=m?b:-b;
if(0===t)T&&(a.wrapperEl.style.scrollSnapType="none",
...
let y=p().isSafari;
return T&&!r&&y&&a.isElement&&a.virtual.update(!1,!1,
n),
a.setTransition(t),
a.setTranslate(b),
a.updateActiveIndex(n),
a.updateSlidesClasses(),
a.emit("beforeTransitionStart",
t,
s),
a.transitionStart(i,
l),0===t?a.transitionEnd(i,
l):a.animating||(a.animating=!0,
...
a=e;
if(r.params.loop)if(r.virtual&&r.params.virtual.enabled)a+=r.virtual.slidesBefore;
else{
let e;
if(l){
...
"auto"===c?c=r.slidesPerViewDynamic():(c=Math.ceil(parseFloat(r.params.slidesPerView,10)),
d&&c%2==0&&(c+=1));
let p=t-e<c;
if(d&&(p=p||e<Math.ceil(c/2)),
s&&d&&"auto"!==r.params.slidesPerView&&!l&&(p=!1),
p){
...
a=r.slides.find(t=>+t.getAttribute("data-swiper-slide-index")===e).column
}
...
s.activeIndex===s.slides.length-1&&l.cssMode)return requestAnimationFrame(()=>{
s.slideTo(s.activeIndex+o,
e,
t,
i)
}
...
return l.rewind&&s.isEnd?s.slideTo(0,
e,
t,
i):s.slideTo(s.activeIndex+o,
e,
t,
i)
}
...
void 0!==e&&(m=f?l[e]:l[e>0?e-1:e])
}
let g=0;
if(void 0!==m&&((g=a.indexOf(m))<0&&(g=s.activeIndex-1),
...
l=Math.min(this.params.slidesPerGroupSkip,
r),
...
return r=Math.min(r=Math.max(r,0),
...
l=t.getSlideIndexWhenGrid(t.clickedIndex),
a=t.isElement?"swiper-slide":`.${
i.slideClass
}
`,
...
i.centeredSlides?t.slideToLoop(e):l>(n?(t.slides.length-r)/2-(t.params.grid.rows-1):t.slides.length-r)?(t.loopFix(),
l=t.getSlideIndex((0,
o.e)(s,`${
a
}
...
let l=i.grid&&s.grid&&s.grid.rows>1;
s.loopAddBlankSlides&&(s.slidesPerGroup>1||l)&&(()=>{
let e=(0,
o.e)(r,`.${
s.slideBlankClass
}
...
let a=s.slidesPerGroup*(l?s.grid.rows:1),
n=i.slides.length%a!=0,
...
;
n?s.loopAddBlankSlides?(c(a-i.slides.length%a),
i.recalcSlides(),
i.updateSlides()):(0,
o.v)("Swiper Loop Warning: The number of slides is not even to slidesPerGroup,
loop mode may not function properly. You need to add more slides (or make duplicates,
or empty slides)"):d&&(s.loopAddBlankSlides?(c(s.grid.rows-i.slides.length%s.grid.rows),
i.recalcSlides(),
i.updateSlides()):(0,
o.v)("Swiper Loop Warning: The number of slides is not even to grid.rows,
loop mode may not function properly. You need to add more slides (or make duplicates,
or empty slides)")),(0,
o.e)(r,`.${
s.slideClass
...
t&&(S||0!==d.snapIndex?S&&d.snapIndex<f.slidesPerView?d.slideTo(d.virtual.slides.length+d.snapIndex,0,!1,!0):d.snapIndex===d.snapGrid.length-1&&d.slideTo(d.virtual.slidesBefore,0,!1,!0):d.slideTo(d.virtual.slides.length,0,!1,!0)),
d.allowSlidePrev=p,
d.allowSlideNext=u,
d.emit("loopFix");
return
...
"auto"===b?b=d.slidesPerViewDynamic():(b=Math.ceil(parseFloat(f.slidesPerView,10)),
S&&b%2==0&&(b+=1));
let T=f.slidesPerGroupAuto?b:f.slidesPerGroup,
y=S?Math.max(T,
Math.ceil(b/2)):T;
y%T!=0&&(y+=T-y%T),
d.loopedSlides=y+=f.loopAdditionalSlides;
let E=d.grid&&f.grid&&f.grid.rows>1;
c.length<b+y||"cards"===d.params.effect&&c.length<b+2*y?(0,
o.v)("Swiper Loop Warning: The number of slides is not enough for loop mode,
it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters"):E&&"row"===f.grid.fill&&(0,
o.v)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
let x=[],
M=[],
P=E?Math.ceil(c.length/f.grid.rows):c.length,
C=l&&P-w<b&&!S,
k=C?w:d.activeIndex;
...
L=0,
I=0,
z=(E?c[r].column:r)+(S&&void 0===s?-b/2+.5:0);
if(z<y){
L=Math.max(y-z,
T);
for(let e=0;
...
if(E){
let e=P-t-1;
for(let t=c.length-1;
t>=0;
t-=1)c[t].column===e&&x.push(t)
}
else x.push(P-t-1)
}
...
"cards"===d.params.effect&&c.length<b+2*y&&(M.includes(r)&&M.splice(M.indexOf(r),1),
...
d.recalcSlides(),
"auto"===f.slidesPerView?d.updateSlides():E&&(x.length>0&&O||M.length>0&&_)&&d.slides.forEach((e,
t)=>{
d.grid.updateSlide(t,
e,
d.slides)
}
),
...
t=d.slidesGrid[k+L]-e;
n?d.setTranslate(d.translate-t):(d.slideTo(k+Math.ceil(L),0,!1,!0),
s&&(d.touchEventsData.startTranslate=d.touchEventsData.startTranslate-t,
d.touchEventsData.currentTranslate=d.touchEventsData.currentTranslate-t))
}
else if(s){
let e=E?x.length/f.grid.rows:x.length;
d.slideTo(d.activeIndex+e,0,!1,!0),
d.touchEventsData.currentTranslate=d.translate
}

}
else if(M.length>0&&_)if(void 0===e){
let e=d.slidesGrid[k],
t=d.slidesGrid[k-I]-e;
n?d.setTranslate(d.translate-t):(d.slideTo(k-I,0,!1,!0),
s&&(d.touchEventsData.startTranslate=d.touchEventsData.startTranslate-t,
d.touchEventsData.currentTranslate=d.touchEventsData.currentTranslate-t))
}
else{
let e=E?M.length/f.grid.rows:M.length;
d.slideTo(d.activeIndex-e,0,!1,!0)
}
...
=this;
this.onTouchStart=S.bind(this),
this.onTouchMove=b.bind(this),
this.onTouchEnd=T.bind(this),
this.onDocumentTouchStart=P.bind(this),
...
c=["window",
"container"].includes(s.breakpointsBase)||!s.breakpointsBase?e.el:a.querySelector(s.breakpointsBase),
p=e.getBreakpoint(l,
d,
c);
...
grid-column`),
e.emitContainerClasses()):!h&&f&&(r.classList.add(`${
s.containerModifierClass
}
grid`),(u.grid.fill&&"column"===u.grid.fill||!u.grid.fill&&"column"===s.grid.fill)&&r.classList.add(`${
s.containerModifierClass
}
grid-column`),
e.emitContainerClasses()),
m&&!g?e.unsetGrabCursor():!m&&g&&e.setGrabCursor(),["navigation",
"pagination",
"scrollbar"].forEach(t=>{
...
S=s.loop&&(u.slidesPerView!==s.slidesPerView||w),
b=s.loop;
w&&i&&e.changeDirection(),(0,
o.x)(e.params,
u);
...
v&&!T?e.disable():!v&&T&&e.enable(),
e.currentBreakpoint=p,
e.emit("_beforeBreakpoint",
u),
i&&(S?(e.loopDestroy(),
e.loopCreate(t),
e.updateSlides()):!b&&y?(e.loopCreate(t),
e.updateSlides()):b&&!y&&e.loopDestroy()),
e.emit("breakpoint",
u)
}
,
...
a.sort((e,
t)=>parseInt(e.value,10)-parseInt(t.value,10));
for(let e=0;
e<a.length;
e+=1){
let{
...
=a[e];
"window"===t?r.matchMedia(`(min-width: ${
n
}
px)`).matches&&(s=l):n<=i.clientWidth&&(s=l)
}
return s||"max"
}
...
!0===t.allowSlideNext&&(this.allowSlideNext=!this.isLocked),!0===t.allowSlidePrev&&(this.allowSlidePrev=!this.isLocked),
...
let t,
i;
1===e.length&&e[0].constructor&&"Object"===Object.prototype.toString.call(e[0]).slice(8,-1)?i=e[0]:[t,
i]=e,
i||(i={
...
"navigation"===s&&e[s]&&e[s].enabled&&!e[s].prevEl&&!e[s].nextEl&&(e[s].auto=!0),["pagination",
"scrollbar"].indexOf(s)>=0&&e[s]&&e[s].enabled&&!e[s].el&&(e[s].auto=!0),
s in e&&"enabled"in r)?void("object"==typeof e[s]&&!("enabled"in e[s])&&(e[s].enabled=!0),!e[s]&&(e[s]={
enabled:!1
}
),(0,
o.x)(t,
...
e.emit("_slideClasses",
t)
}
slidesPerViewDynamic(e="current",
t=!1){
let{
params:i,
slides:s,
...
for(let i=n+1;
i<s.length;
i+=1)s[i]&&!e&&(t+=Math.ceil(s[i].swiperSlideSize),
o+=1,
t>a&&(e=!0));
for(let i=n-1;
i>=0;
i-=1)s[i]&&!e&&(t+=s[i].swiperSlideSize,
o+=1,
t>a&&(e=!0))
}
else if("current"===e)for(let e=n+1;
e<s.length;
e+=1)(t?r[e]+l[e]-r[n]<a:r[e]-r[n]<a)&&(o+=1);
else for(let e=n-1;
e>=0;
e-=1)r[n]-r[e]<a&&(o+=1);
return o
...
=t;
function r(){
let e=Math.min(Math.max(t.rtlTranslate?-1*t.translate:t.translate,
t.maxTranslate()),
t.minTranslate());
t.setTranslate(e),
t.updateActiveIndex(),
...
t.updateProgress(),
t.updateSlidesClasses(),
s.freeMode&&s.freeMode.enabled&&!s.cssMode)r(),
...
e===i||"horizontal"!==e&&"vertical"!==e||(this.el.classList.remove(`${
...
this.rtl?(this.el.classList.add(`${
this.params.containerModifierClass
}
rtl`),
this.el.dir="rtl"):(this.el.classList.remove(`${
this.params.containerModifierClass
}
rtl`),
this.el.dir="ltr"),
...
t.params.loop&&t.virtual&&t.params.virtual.enabled?t.slideTo(t.params.initialSlide+t.virtual.slidesBefore,0,
t.params.runCallbacksOnInit,!1,!0):t.slideTo(t.params.initialSlide,0,
...
),!1!==e&&(i.el&&"string"!=typeof i.el&&(i.el.swiper=null),(0,
o.y)(i)),
i.destroyed=!0),
null
}
...
a),
s.addEventListener("orientationchange",
o)
}
),
t("destroy",()=>{
...
let a=new(l.MutationObserver||l.WebkitMutationObserver)(t=>{
...
void 0===e[i]?e[i]=t[i]:A(t[i])&&A(e[i])&&Object.keys(t[i]).length>0?t[i].__swiper__?e[i]=t[i]:D(e[i],
t[i]):e[i]=t[i]
}
)
}
...
t++){
var i=arguments[t];
for(var s in i)Object.prototype.hasOwnProperty.call(i,
s)&&(e[s]=i[s])
}
return e
}
...
,
e)).forEach(n=>{
void 0!==e[n]&&(a.indexOf(n)>=0?A(e[n])?(i[n]={
...
D(r[n],
e[n])):(i[n]=e[n],
r[n]=e[n]):0===n.search(/on[A-Z]/)&&"function"==typeof e[n]?t?s[`${
n[2].toLowerCase()
}
${
n.substr(3)
...
;
D(w.current.params.virtual,
e),
D(w.current.originalParams.virtual,
e)
}
...
;
return v.current||W(),
w.current&&w.current.on("_beforeBreakpoint",
R),(0,
a.useEffect)(()=>()=>{
w.current&&w.current.off("_beforeBreakpoint",
R)
}
),(0,
a.useEffect)(()=>{
...
v.current)return w.current.destroyed&&W(),!function({
el:e,
nextEl:t,
prevEl:i,
paginationEl:s,
...
,
a){
G(a)&&t&&i&&(l.params.navigation.nextEl=t,
l.originalParams.navigation.nextEl=t,
l.params.navigation.prevEl=i,
l.originalParams.navigation.prevEl=i),
N(a)&&s&&(l.params.pagination.el=s,
l.originalParams.pagination.el=s),
V(a)&&r&&(l.params.scrollbar.el=r,
...
,
M),
r&&!w.current.destroyed&&r(w.current),()=>{
...
return z.filter(e=>"_"===e[0]).map(e=>e.replace(/_/,
"")).forEach(i=>{
if(i in e&&i in t)if(A(e[i])&&A(t[i])){
...
return S.current=P,
b.current=O,
e.length&&w.current&&!w.current.destroyed&&function({
swiper:e,
slides:t,
passedParams:i,
changedParams:s,
...
m,
g,
v=s.filter(e=>"children"!==e&&"direction"!==e&&"wrapperClass"!==e),{
params:w,
pagination:S,
navigation:b,
scrollbar:T,
...
=e;
s.includes("thumbs")&&i.thumbs&&i.thumbs.swiper&&!i.thumbs.swiper.destroyed&&w.thumbs&&(!w.thumbs.swiper||w.thumbs.swiper.destroyed)&&(d=!0),
s.includes("controller")&&i.controller&&i.controller.control&&w.controller&&!w.controller.control&&(c=!0),
s.includes("pagination")&&i.pagination&&(i.pagination.el||n)&&(w.pagination||!1===w.pagination)&&S&&!S.el&&(p=!0),
s.includes("scrollbar")&&i.scrollbar&&(i.scrollbar.el||a)&&(w.scrollbar||!1===w.scrollbar)&&T&&!T.el&&(u=!0),
s.includes("navigation")&&i.navigation&&(i.navigation.prevEl||l)&&(i.navigation.nextEl||r)&&(w.navigation||!1===w.navigation)&&b&&!b.prevEl&&!b.nextEl&&(h=!0);
let x=t=>{
e[t]&&(e[t].destroy(),
...
;
s.includes("loop")&&e.isElement&&(w.loop&&!i.loop?f=!0:!w.loop&&i.loop?m=!0:g=!0),
v.forEach(e=>{
if(A(w[e])&&A(i[e]))Object.assign(w[e],
i[e]),("navigation"===e||"pagination"===e||"scrollbar"===e)&&"enabled"in i[e]&&!i[e].enabled&&x(e);
else{
let t=i[e];
...
v.includes("controller")&&!c&&e.controller&&e.controller.control&&w.controller&&w.controller.control&&(e.controller.control=w.controller.control),
s.includes("children")&&t&&y&&w.virtual.enabled?(y.slides=t,
y.update(!0)):s.includes("virtual")&&y&&w.virtual.enabled&&(t&&(y.slides=t),
y.update(!0)),
s.includes("children")&&t&&w.loop&&(g=!0),
d&&E.init()&&E.update(!0),
c&&(e.controller.control=w.controller.control),
p&&(e.isElement&&(!n||"string"==typeof n)&&((n=document.createElement("div")).classList.add("swiper-pagination"),
...
S.render(),
S.update()),
u&&(e.isElement&&(!a||"string"==typeof a)&&((a=document.createElement("div")).classList.add("swiper-scrollbar"),
...
T.updateSize(),
T.setTranslate()),
h&&(e.isElement&&(r&&"string"!=typeof r||((r=document.createElement("div")).classList.add("swiper-button-next"),(0,
o.s)(r,
e.navigation.arrowSvg),
r.part.add("button-next"),
e.el.appendChild(r)),
l&&"string"!=typeof l||((l=document.createElement("div")).classList.add("swiper-button-prev"),(0,
o.s)(l,
e.navigation.arrowSvg),
l.part.add("button-prev"),
e.el.appendChild(l))),
r&&(w.navigation.nextEl=r),
...
s.includes("direction")&&e.changeDirection(i.direction,!1),(f||g)&&e.loopDestroy(),(m||g)&&e.loopCreate(),
e.update()
}
({
swiper:w.current,
...
return e?e.includes("swiper-wrapper")?e:`swiper-wrapper ${
e
}
`:"swiper-wrapper"
}
...
for(let e=o;
e<d;
e+=1)e>=l&&e<=n&&c.push(t[s(e)]);
return c.map((t,
i)=>a.cloneElement(t,{
swiper:e,
style:r,
key:t.props.virtualIndex||t.key||`slide-${
i
}
`
}
...
L["wrapper-end"]),
G(M)&&a.createElement(a.Fragment,
null,
a.createElement("div",{
ref:y,
...
F(()=>{
if(void 0!==o&&(p.current.swiperSlideIndex=o),
c&&(c.current=p.current),
p.current&&s){
if(s.destroyed){
"swiper-slide"!==u&&h("swiper-slide");
return
}
return s.on("_slideClass",
g),()=>{
s&&s.off("_slideClass",
g)
}
...
"prototype"];
Object.keys(t).filter(e=>0>i.indexOf(e)).forEach(i=>{
void 0===e[i]?e[i]=t[i]:s(t[i])&&s(e[i])&&Object.keys(t[i]).length>0&&r(e[i],
t[i])
}
)
}
...
l);
void 0!==a&&a.enumerable&&(o(i[l])&&o(r[l])?r[l].__swiper__?i[l]=r[l]:e(i[l],
r[l]):!o(i[l])&&o(r[l])?(i[l]={

}
,
r[l].__swiper__?i[l]=r[l]:e(i[l],
r[l])):i[l]=r[l])
}
...
i=(0,
s.a)();
return i.getComputedStyle&&(t=i.getComputedStyle(e,
null)),!t&&e.currentStyle&&(t=e.currentStyle),
t||(t=e.style),
t
}
(e);
return a.WebKitCSSMatrix?((r=o.transform||o.webkitTransform).split(",
").length>6&&(r=r.split(",
").map(e=>e.replace(",
",
".")).join(",
")),
l=new a.WebKitCSSMatrix("none"===r?"":r)):i=(l=o.MozTransform||o.OTransform||o.MsTransform||o.msTransform||o.transform||o.getPropertyValue("transform").replace("translate(",
"matrix(1, 0, 0, 1,
")).toString().split(",
"),
...
l.cancelAnimationFrame(e.cssModeFrameID);
let d=t>a?"next":"prev",
c=(e,
t)=>"next"===d&&e>=t||"prev"===d&&e<=t,
p=()=>{
r=new Date().getTime(),
null===n&&(n=r);
let s=a+(.5-Math.cos(Math.max(Math.min((r-n)/o,1),0)*Math.PI)/2)*(t-a);
if(c(s,
t)&&(s=t),
...
e.cssModeFrameID=l.requestAnimationFrame(p)
}
;
p()
}
...
s.a)(),
r=t.contains(e);
return!r&&i.HTMLSlotElement&&t instanceof HTMLSlotElement&&((r=[...t.assignedElements()].includes(e))||(r=function(e,
t){
let i=[t];
for(;
i.length>0;
...
let r=(0,
s.a)();
return i?e["width"===t?"offsetWidth":"offsetHeight"]+parseFloat(r.getComputedStyle(e,
null).getPropertyValue("width"===t?"margin-right":"margin-top"))+parseFloat(r.getComputedStyle(e,
