"use strict";
(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[90575],{
16076:(e,
t,
r)=>{
r.r(t),
...
function x(e){
return n.isValidElement(e)&&"function"==typeof e.type&&"__radixId"in e.type&&e.type.__radixId===y
}
var b=r(62146),
S=r(58162),
C=r(81285),
...
A=n.useRef(null),
B=!b||y||!!b.closest("form"),[V,
O]=n.useState(new Set),
W=Array.from(V).map(e=>e.props.value).join(";
");
return(0,
w.jsx)(v.bL,{
...x,
...
u||(d.onOpenChange(!0),
y()),
e&&(d.triggerPointerDownPosRef.current={
...
"data-placeholder":eR(d.value)?"":void 0,...o,
ref:c,
onClick:(0,
a.mK)(o.onClick,
e=>{
...
onPointerDown:(0,
a.mK)(o.onPointerDown,
e=>{
f.current=e.pointerType;
let t=e.target;
t.hasPointerCapture(e.pointerId)&&t.releasePointerCapture(e.pointerId),0===e.button&&!1===e.ctrlKey&&"mouse"===e.pointerType&&(x(e),
e.preventDefault())
}
),
onKeyDown:(0,
...
e=>{
let t=""!==h.current;
e.ctrlKey||e.altKey||e.metaKey||1!==e.key.length||m(e.key),(!t||" "!==e.key)&&R.includes(e.key)&&(x(),
e.preventDefault())
}
)
}
...
let e,
a,
i=(o=r,(a=(e=Object.getOwnPropertyDescriptor(o.props,
"ref")?.get)&&"isReactWarning"in e&&e.isReactWarning)?o.ref:(a=(e=Object.getOwnPropertyDescriptor(o,
"ref")?.get)&&"isReactWarning"in e&&e.isReactWarning)?o.props.ref:o.props.ref||o.ref),
d=function(e,
t){
let r={
...t
...
(l,
r.props);
return r.type!==n.Fragment&&(d.ref=t?(0,
s.t)(t,
i):i),
n.cloneElement(r,
d)
...
l=a.map(t=>t!==i?t:n.Children.count(e)>1?n.Children.only(null):n.isValidElement(e)?e.props.children:null);
return(0,
w.jsx)(t,{
...o,
ref:r,
...
let[t,...r]=B().map(e=>e.ref.current),[n]=r.slice(-1),
l=document.activeElement;
for(let r of e)if(r===l||(r?.scrollIntoView({
block:"nearest"
}
),
r===t&&I&&(I.scrollTop=0),
...
,
r=r=>{
e.x<=10&&e.y<=10?r.preventDefault():T.contains(r.target)||z(!1),
document.removeEventListener("pointermove",
t),
U.current=null
}
;
return null!==U.current&&(document.addEventListener("pointermove",
t),
...
,[R.value]),
et=n.useCallback(()=>T?.focus(),[T]),
er=n.useCallback((e,
t,
r)=>{
let n=!W.current&&!r;
(void 0!==R.value&&R.value===t||n)&&H(e)
}
,[R.value]),
en="popper"===l?ee:$,
el=en===ee?{
...
dir:R.dir,
onContextMenu:e=>e.preventDefault(),...j,...el,
onPlaced:()=>O(!0),
ref:D,
style:{
display:"flex",
flexDirection:"column",
outline:"none",...j.style
}
,
onKeyDown:(0,
a.mK)(j.onKeyDown,
...
t||1!==e.key.length||J(e.key),["ArrowUp",
"ArrowDown",
"Home",
"End"].includes(e.key)){
let t=B().filter(e=>!e.disabled).map(e=>e.ref.current);
if(["ArrowUp",
"End"].includes(e.key)&&(t=t.slice().reverse()),["ArrowUp",
...
=d,
k=n.useCallback(()=>{
if(i.trigger&&i.valueNode&&u&&p&&x&&b&&S){
...
c=o(a,[10,
Math.max(10,
window.innerWidth-10-d)]);
u.style.minWidth=s+"px",
u.style.left=c+"px"
}
else{
...
u.style.bottom="0px";
let t=Math.max(s-N,
R+(e?k:0)+(p.clientHeight-x.offsetTop-x.offsetHeight)+g);
...
u.style.top="0px";
let t=Math.max(N,
f+x.offsetTop+(e?j:0)+R);
u.style.height=t+(w-T)+"px",
x.scrollTop=T-N+x.offsetTop
}
...
var ee=n.forwardRef((e,
t)=>{
let{
__scopeSelect:r,
align:n="start",
collisionPadding:l=10,...o
}
=e,
a=L(r);
return(0,
...
__html:"[data-radix-select-viewport]{
...
l=Math.max(parseFloat(r.style.minHeight),
...
i=o-a;
r.style.height=a+"px",
"0px"===r.style.bottom&&(t.scrollTop=i>0?i:0,
...
onPointerDown:(0,
a.mK)(d.onPointerDown,
e=>{
S.current=e.pointerType
}
),
onPointerMove:(0,
a.mK)(d.onPointerMove,
e=>{
S.current=e.pointerType,
o?c.onItemLeave?.():"mouse"===S.current&&e.currentTarget.focus({
preventScroll:!0
}
)
}
...
a.mK)(d.onKeyDown,
e=>{
(c.searchRef?.current===""||" "!==e.key)&&(T.includes(e.key)&&C(),
...
c.isSelected&&d.valueNode&&!d.valueNodeHasChildren?l.createPortal(i.children,
d.valueNode):null]
}
)
}
...
e),()=>t.removeEventListener("scroll",
e)
}
...
onPointerMove:(0,
a.mK)(o.onPointerMove,()=>{
i.onItemLeave?.(),
null===s.current&&(s.current=window.setInterval(l,50))
}
),
onPointerLeave:(0,
a.mK)(o.onPointerLeave,()=>{
u()
}
)
}
...
a=J(ek,
r);
return o.open&&"popper"===a.position?(0,
w.jsx)(v.i3,{
...l,...n,
ref:t
}
...
let e=o.current;
if(!e)return;
let r=Object.getOwnPropertyDescriptor(window.HTMLSelectElement.prototype,
"value").set;
if(i!==t&&r){
...
,[]);
return n.useEffect(()=>()=>window.clearTimeout(l.current),[]),[r,
o,
a]
}
function eE(e,
